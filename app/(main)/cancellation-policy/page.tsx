  ...
  return (
    <div className="pt-32 pb-24 px-6 md:px-12 max-w-4xl mx-auto">
      ...
      <div className="space-y-8 text-slate-600 dark:text-slate-300">
        ...
        <section className="bg-white dark:bg-[#0a110a] p-8 rounded-2xl border border-slate-200 dark:border-white/5 shadow-sm">
          ...
          <ul className="list-disc pl-5 space-y-3">
            <li><strong className="text-slate-800 dark:text-slate-200">60 days or more before departure:</strong> Loss of 20% deposit.</li>
            <li><strong className="text-slate-800 dark:text-slate-200">30 to 59 days before departure:</strong> 50% of total trip cost.</li>
            <li><strong className="text-slate-800 dark:text-slate-200">15 to 29 days before departure:</strong> 75% of total trip cost.</li>
            <li><strong className="text-slate-800 dark:text-slate-200">Less than 15 days before departure:</strong> 100% of total trip cost (No refund).</li>
          </ul>
        </section>
